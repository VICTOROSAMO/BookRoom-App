...
public class MaleBooking1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_male_booking1);
    ...
    private void ClearAll(){
        ...
        book_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MaleBooking1.this, MbookRoom1.class));
            }
        });
    }
