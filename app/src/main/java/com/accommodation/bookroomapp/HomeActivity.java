    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(HomeActivity.this, "Welcome to male student's Hostels", Toast.LENGTH_LONG).show();
            }
        });
        ...
        fBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this, MainActivity2.class));
                Toast.makeText(HomeActivity.this, "Welcome to female student's Hostels", Toast.LENGTH_LONG).show();
            }
        });
