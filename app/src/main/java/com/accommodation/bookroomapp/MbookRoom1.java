...
public class MbookRoom1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbook_room1);
        ...
        public void showAddStudentDialog() {
                ...
                public void dialogueSubmit(){
                 ...
                 dialog.show();
                    ...
                    h.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            startActivity(new Intent(MbookRoom1.this, FinalActivity.class));
                            dialog.dismiss();
                        }
                    },5000);
            ...
            builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    dialog.cancel();
                    startActivity(new Intent(MbookRoom1.this, MaleBooking1.class));
                }
            });
