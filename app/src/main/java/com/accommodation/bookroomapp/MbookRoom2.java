...
public class MbookRoom2 extends AppCompatActivity {
    Button btn;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbook_room2);
    ...
    public void showAddStudentDialog() {
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            ...
            public void dialogueSubmit(){
                ...
                h.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(MbookRoom2.this, FinalActivity.class));
                        dialog.dismiss();
                    }
                },5000);
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                startActivity(new Intent(MbookRoom2.this, MaleBooking2.class));
            }
        });
