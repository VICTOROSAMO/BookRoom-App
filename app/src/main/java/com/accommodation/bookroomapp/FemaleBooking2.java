...
public class FemaleBooking2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_female_booking2);
    ...
    private void ClearAll(){
        ...
        book_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(FemaleBooking2.this, FbookRoom2.class));
            }
        });
