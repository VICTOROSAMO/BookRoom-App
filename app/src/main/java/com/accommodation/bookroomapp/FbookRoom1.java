...
public class FbookRoom1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fbook_room1);
    ...
    public void showAddStudentDialog() {
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            ...
            public void dialogueSubmit(){
                ...
                h.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(FbookRoom1.this, FinalActivity.class));
                        dialog.dismiss();
                    }
                },5000);
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                startActivity(new Intent(FbookRoom1.this, FemaleBooking1.class));
            }
        });
